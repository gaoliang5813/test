...
int init_filtering_drawtext(){
    const char *filter_descr_drawtext = "drawtext=fontfile=FreeSans.ttf:fontcolor=blue@0.5:fontsize=150:x=200:y=500:box=1: boxcolor=red@0.2:text='Hello,world'";
    if (init_filters(filter_descr_drawtext) < 0)
        return 1;
    return 0;
}
